...
def test_manager_avg_response_time(db, django_user_model):
    ...
    # create client message then manager reply with a 30s gap
    ...
    # update timestamps to create a delta
    ...
    resp = view(req)
    # view returns Response; when called as function it is a Response object
    assert resp.status_code == 200
    data = resp.data
    # find our manager in result
